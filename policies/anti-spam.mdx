...
This Spam Policy pertains to all Websites owned or operated by BYIO Singapore Pte. Ltd. (hereinafter "[CloudBud.Com](http://CloudBud.Com) "). [CloudBud.com](http://CloudBud.com) subscribes to a strict "No Spam" Policy as exhibited and explained by this Policy. [Vultr.com](http://Vultr.com) will not profit from, nor allow anyone else to profit from Spam of any kind. [Vultr.com](http://Vultr.com) will terminate any and all relationships with any entity producing illegal Spam, and [Vultr.com](http://Vultr.com) will cooperate with law enforcement to see to it that illegal spammers are prosecuted to the fullest extent of the law.

- Who should read and follow this Policy:
  - If you have any relationship, whatsoever, to [CloudBud.com](http://CloudBud.com), you must, as a condition of a continued relationship with [Vultr.com](http://Vultr.com) read and familiarize yourself with this Policy and follow it in its entirety.
